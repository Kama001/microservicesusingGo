...
const file_currency_proto_rawDesc = "" +
	...
	"\vDestination\x18\x02 \x01(\tR\vDestination\"r\n" +
	...
	"\x03ZAR\x10 22\n" +
	"\bCurrency\x12&\n" +
	"\aGetRate\x12\f.RateRequest\x1a\r.RateResponseB\rZ\v./;currencyb\x06proto3"
...
var file_currency_proto_depIdxs = []int32{
	0, // 0: RateResponse.Base:type_name -> Currencies
	0, // 1: RateResponse.Destination:type_name -> Currencies
